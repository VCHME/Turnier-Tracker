...
(function(){
  ...
  var tablesBox=$('#tt-tables'), tablesWrap=$('#tt-tables-wrap');
  ...
  function renderTables(){
    ...
    for(var gi=0; gi<gs.length; gi++){
      ...
      var html='<table class="vchme-tt__table '+gcls+'"><thead><tr>'+
        '<th>'+g+'</th><th>P</th><th>W</th><th>L</th><th>PF</th><th>PA</th><th>Diff</th></tr></thead><tbody>';
  ...
  document.addEventListener('click', function(ev){
    ...
    switch(b.id){
      ...
      case 'tt-toggle-tables': {
        ...
        if(content) content.style.display = ui.tablesHidden ? 'none' : 'block';
