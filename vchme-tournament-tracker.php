...
class VCHME_TT_Full {
  ...
  private function enqueue_assets(){
    $css = @file_get_contents(plugin_dir_path(__FILE__).'assets/style.v136.css');
    if($css){
      wp_register_style('vchme-tt-style-v136', false);
      wp_enqueue_style('vchme-tt-style-v136');
      wp_add_inline_style('vchme-tt-style-v136', $css);
    }
    wp_enqueue_script('vchme-tt-app-v136', plugin_dir_url(__FILE__).'assets/app.v136.js', array(), '1.3.6', true);
  }
